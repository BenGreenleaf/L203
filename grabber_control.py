...
def lift_up():
    global lift_angle
    lift_angle = move_servo(lift, lift_angle, 30) #140
    return True

def lift_down_bottom_rack():
    global lift_angle
    lift_angle = move_servo(lift, lift_angle, 42)
    return True

def lift_down_top_rack():
    global lift_angle
    lift_angle = move_servo(lift, lift_angle, 50)
    return True
...
def grab_open():
    global grab_angle
    grab_angle = move_servo(grab, grab_angle, 31)
    return True
